...
# "logs/087_experiment_octo_only_vary_kl/PushCube-v1/octo_only/2025-03-12-16-05-34/"
ROOT_PATH = "logs/089_experiment_octo_only_vary_kl_26/PushCube-v1/octo_only/2025-03-13-17-14-40/"
SAMPLE_MODEL_PATH = (
     ROOT_PATH +"089_experiment_octo_only_vary_kl_26/model_ckpt"
    #"logs/087_experiment_octo_only_vary_kl/PushCube-v1/octo_only/2025-03-12-04-01-55/087_experiment_octo_only_vary_kl/model_ckpt"
    # "/mnt/dataset_drive/piscenco/logs2/062_experiment_ppo_octoonly_target_kl_null_eptropy_0_1/PushCube-v1/octo_only/2025-02-22-18-34-49/062_experiment_ppo_octoonly_target_kl_null_eptropy_0_1/model_ckpt"
)
SAMPLE_PATH_TO_CONFIG = (
    ROOT_PATH + ".hydra/config.yaml"
    # "logs/087_experiment_octo_only_vary_kl/PushCube-v1/octo_only/2025-03-12-04-01-55/.hydra/config.yaml"
    # "/mnt/dataset_drive/piscenco/logs2/062_experiment_ppo_octoonly_target_kl_null_eptropy_0_1/PushCube-v1/octo_only/2025-02-22-18-34-49/.hydra/config.yaml"
    # "/mnt/dataset_drive/piscenco/logs2/063_experiment_ppo_octo_only_target_kl_100k_clip_1/PushCube-v1/octo_only/2025-02-23-16-28-11/.hydra/config.yaml"
    #  /mnt/dataset_drive/piscenco/logs/045_experiment_octo_epsilon_0_5_PushCube_seed_13_clip0
    # _2_200k_steps_27_01_ckpt/PushCube-v1/octo_epsilon/2025-01-29-23-03-18/.hydra/config.yaml
)
######################### Logging ##################################################
logging.basicConfig(
...
# time CUDA_VISIBLE_DEVICES=0 python3 /home/piscenco/thesis_octo/thesis-code/octoplus/src/evaluate_main.py >> eval_result.txt
def evaluate_model(
    model_path: str,
    path_to_config: str,
    num_parallel: int,
    ...
    if print_config:
        print(f"# seed: {cfg.env_config.seed} target_kl: {cfg.model_config.target_kl}")
        print(f"# Config: {cfg}")
    ...
    cfg.env_config.reward_mode = "dense" # "normalized_dense" Can't find how they normalize it, may make runs incomparable?
...
# CUDA_VISIBLE_DEVICES=1 python3 /home/piscenco/thesis_octo/thesis-code/octoplus/src/evaluate_main.py 
if __name__ == "__main__":
    ...
    if "--help" in sys.argv:
        ...
        parser.add_argument(
            "--total_num_env", type=int, default=1000, help="Number of env to run"
        )
        parser.add_argument(
            "--path_to_config",
            type=str,
